...
## Legacy version
This is the legacy v1.x series of the library. While bug fixes and minimal feature improvements are made to this version, please consider using the [new version v2.x](https://github.com/Ayesh/php-timer/tree/v2).
